//go:build all || multicluster_outerloop || multicluster_outerloop_basic || multicluster_outerloop_ns_provisioner_test_basic
...
func TestOuterloopNsProvisionerBasicSupplychainGitOps(t *testing.T) {
	t.Log("************** TestCase START: TestOuterloopNsProvisionerBasicSupplychainGitOps **************")
	testenv.Test(t,
		...
		common_features.UpdateTapProfileNamespaceProvisioner(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.Tap.Version, "build", "basic", suiteConfig.Tap.Namespace, false, suiteConfig.Tap.PollTimeout, outerloopConfig.Namespace, outerloopConfig.Namespace2),
		...
		common_features.ApplyKubectlConfigurationFile(t, outerloopConfig.NsProvisionerGitops.YamlFile, ""),
		common_features.UpdateTapProfileNamespaceProvisioner(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.Tap.Version, "run", "basic", suiteConfig.Tap.Namespace, false, suiteConfig.Tap.PollTimeout, outerloopConfig.Namespace, outerloopConfig.Namespace2),
		...
		common_features.UpdateTapProfileNamespaceProvisioner(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.Tap.Version, "build", "basic", suiteConfig.Tap.Namespace, true, suiteConfig.Tap.PollTimeout, outerloopConfig.Namespace, outerloopConfig.Namespace2),
	...
	t.Log("************** TestCase END: TestOuterloopNsProvisionerBasicSupplychainGitOps **************")
}
