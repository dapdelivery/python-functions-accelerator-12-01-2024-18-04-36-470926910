...
// +build all multicluster_outerloop multicluster_outerloop_scan_multiapps
...
func TestOuterloopScanSupplychainMultipleApps(t *testing.T) {
	...
	testenv.Test(t,
		...
		// common_features.DeletePipeline(t, outerloopConfig.BuildPacks.PipelineName, outerloopConfig.Namespace),
