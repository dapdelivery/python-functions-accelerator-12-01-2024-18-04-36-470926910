//go:build server_worker_testing_supply_chain
// +build server_worker_testing_supply_chain
...
func TestServerWorkerOuterloopTestingSupplyChain(t *testing.T) {
	t.Log("************** TestCase START: TestServerWorkerOuterloopTestingSupplyChain **************")
	testenv.Test(t,
		//view context
		...
		common_features.UpdateTapProfileSupplyChain(t, suiteConfig.Tap.Name, suiteConfig.Tap.PackageName, suiteConfig.Tap.Version, "run", "testing", suiteConfig.Tap.Namespace, suiteConfig.Tap.PollTimeout),
	...
	t.Log("************** TestCase END: TestServerWorkerOuterloopTestingSupplyChain **************")
}
